...
id_range:
  ...
  cl: "C-FEED-01 (mới, → Partially Resolved 2026-09-16) + C-ASN-01/02, C-ORD-06 (tham chiếu — home ở ASN/ACT)"
...
| 3 | 🟡 `C-FEED-01(b)` — bản đồ thật vs placeholder | Doc tự đặt câu hỏi; vibe-check 2026-09-16 chỉ xác nhận được hiện trạng (placeholder), không trả lời được ý định scope | Hỏi BA/PM về scope v1.0 chính thức; `RISK-FEED-05` giữ `Pending` |
