...
| SC-DLV-024 | [GAP] Nhắc 2 giờ → admin | REQ-DLV-007 | DOC-v1.0-01 §D4 BR-CNF-04 L266 · §D1b US-D14 L193 | Đơn ở "Đã giao"; Receiver KHÔNG xác nhận | Chờ quá 2 giờ, rồi chờ thêm 2 giờ (hoặc nhờ dev seed timestamp) | Sau 2 giờ: hệ thống gửi nhắc cho Receiver. Sau 4 giờ: chuyển sang "admin hỗ trợ". ⚠ Nếu chưa chạy đủ mốc thời gian → GHI RÕ, ⛔ không khai coverage | P2 | Business Rule | NEW |
