...
| SC-DLV-050 | Chế độ retry — quay lại IN_TRANSIT theo lịch hẹn | REQ-DLV-019 | DOC-v1.1-01 §8.9.1 BR09-05 | Đơn ở RESCHEDULED, đã tới lịch hẹn giao lại | Carrier mở lại màn giao hàng theo lịch | Đơn quay lại IN_TRANSIT; giao lại theo đúng luồng `REQ-DLV-017` (FR07) | P2 | Functional | NEW |
