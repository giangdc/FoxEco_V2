...
1b. **`C-DLV-02` (GPS-01) có thêm bằng chứng phủ định** — màn "Đang giao" trên demo không có control chia sẻ vị trí nào, củng cố nghi vấn bề mặt chưa tồn tại. Vẫn cần PM xác nhận scope chính thức.
