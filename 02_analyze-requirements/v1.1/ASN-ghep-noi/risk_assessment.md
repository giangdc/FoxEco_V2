...
| C-ASN-04 | Rule "5 thông báo / 1 tin đăng OFFER" — ai nhận, chọn 5 tin nào, có quét lại khi có tin NEED mới không | ✅ **Resolved 2026-09-17** — BA trả lời đủ (a)-(e), trần độc lập theo từng tuyến — ⚠️ **vế (e) đính chính 2026-09-21: trần theo TÀI KHOẢN** | 2026-09-16 | REQ-ASN-006, REQ-ASN-008, REQ-ASN-009, SC-ASN-013, SC-ASN-014 |
...
↳ **ĐÍNH CHÍNH 2026-09-21 — vế (e):** BA xác nhận lại (QC GiangDC2 báo lại; chưa có văn bản): **trần 5 thông báo khớp tuyến tính theo TÀI KHOẢN, mọi tuyến cộng dồn** — ⛔ **không** còn là *"độc lập theo từng tuyến"*. Căn cứ đo: `VR-010` (5 tin khớp → 4 mới + 1 tồn = 5; tuyến OFFER thứ 2 0/5 slot vẫn 0 thông báo). `TC-ASN-016`/`025` đã sửa Expected theo rule này (2026-09-21).
