...
| SC-ASN-014 | Trần thông báo khớp — **5 thông báo / 1 tin đăng OFFER**, KHÔNG có trần theo ngày *(đảo lần 2 — BA 2026-09-16)* | REQ-ASN-008 | DOC-v1.1-01 §8.4 BR04-04 *(BA xác nhận dư)* · BA trả lời `C-NTF-02` 2026-09-16 | Có **≥ 6** tin NEED ở `POSTED` cùng khớp tuyến P1→P2 (khoảng ngày + buổi giao nhau) | Carrier B đăng 1 tin OFFER P1→P2 | B nhận **tối đa 5** thông báo `NTF-03` cho tin OFFER này; ⛔ KHÔNG assert trần theo ngày. ✅ **Chốt 2026-09-17 (`C-ASN-04` Resolved, BA trả lời đủ (a)–(e)):** người nhận = **Carrier ĐĂNG TUYẾN**; chọn 5 tin theo **thời gian đăng** (tin đăng trước ưu tiên trước — **cùng 1 rule** với trần gợi ý 5 của `BR03-06`); <5 tin khớp thì gửi đúng số đó, 0 tin thì không gửi; tin NEED đăng SAU chỉ được gửi thêm nếu tuyến **chưa đủ 5**; mỗi tuyến có trần **ĐỘC LẬP** 5 (đăng 2 tuyến ⇒ tối đa 10, ⛔ không cộng dồn chung) ⇒ **assert được đủ 3 vế** (người nhận · thứ tự chọn · chiều NEED-mới), ⛔ không còn dừng ở *"không vượt 5"* | P2 | Business Rule | MODIFIED |
