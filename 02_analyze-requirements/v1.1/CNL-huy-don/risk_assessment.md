...
| RISK-CNL-06 | CNL / Scope | *(cập nhật Status 2026-09-17)* PM xếp `CNL` out of scope Phase 1 (`KP-03 §3.1`) — nhưng **PRD v1.1 đặc tả đầy đủ `FR11`** và đưa huỷ đơn vào business process chính (`S-04`) ⇒ căn cứ "out of scope" đã hết hiệu lực | Low → **Resolved — IN scope** | `DOC-v1.1-01` §7.2 dòng FR11 · §5 Business Process vs `KP-03` §3.1 (2026-07) | — | Đã xác nhận **IN scope v1.1**, chạy đủ 17 SC (kể cả 8 CARRIED) | Resolved (QC GiangDC2 xác nhận 2026-09-17) | toàn module |
...
4. ✅ **Scope đã xác nhận IN 2026-09-17** (`RISK-CNL-06` Resolved, QC GiangDC2) — `KP-03 §3.1` (2026-07) từng xếp out-of-scope Phase 1, nhưng PRD v1.1 (09/2026) đặc tả đầy đủ `FR11` và đặt nó vào business process chính. Chạy đủ 17 SC.
