...
| 4 | Nhấn vào thông báo quà cảm ơn | tap dòng thông báo đầu | ✅ **PASS** *(đính chính 2026-09-21 — lúc chạy chấm ❌ FAIL)* | `TC-GIFT-012__step4-FAIL-mo-qua-da-nhan-khong-phai-trang-ca-nhan.png` | — |
...
| E4 | ~~Mở màn Cá nhân của tài khoản B~~ → **Mở thẳng màn "Quà đã nhận" của tài khoản B** *(Expected đã sửa 2026-09-21)* | Mở **màn `"Quà đã nhận"`** (đúng Expected mới) | ✅ **PASS** *(đính chính 2026-09-21 — lúc chạy chấm ❌ FAIL theo Expected cũ)* | *(ảnh step 4)* | Deep-link **sâu hơn 1 cấp** so với cả spec lẫn **chính câu chữ của thông báo** (*"mở Trang cá nhân để xem"*) |

**Result: ✅ PASS** *(đính chính 2026-09-21 — lúc chạy: ❌ FAIL tại Step 4)*
**Expected (mới):** nhấn thông báo → mở thẳng màn **"Quà đã nhận"** · **Actual:** mở thẳng màn **"Quà đã nhận"**.
...
> *(Nội dung bên dưới là ghi chép lúc chạy, giữ nguyên để truy vết — phần "FAIL"/"mâu thuẫn" đã bị QC bác.)*
