...
> Cập nhật: **2026-09-22** — sinh lại sau khi đồng bộ Status TC-MASTER ← coverage ledger. Bản trước (cũng ghi 2026-09-22) **bỏ sót VR-020/VR-021 (DLV)**: 4 TC `TC-DLV-041/042/043/050` đã PASS mà bảng vẫn đếm là chưa chạy.

## Tổng quan

**163/221 TC v1.1 có verdict cuối = 73.8%** · ✅ PASS **101** (45.7%) · ❌ FAIL 37 · 🚫 BLOCKED 20 · ⛔ N-A 5 · ⏳ chưa có verdict **58** (26.2%)
...
| **Σ** | **221** | **101** | 37 | 20 | 5 | **58** | **73.8%** | 45.7% | |
...
- **GIFT** — chưa chạy 2: 008 011 · FAIL/BLOCKED/N-A: 003❌ 013🚫 014🚫
