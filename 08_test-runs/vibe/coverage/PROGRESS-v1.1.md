...
> Cập nhật: 2026-09-21 · sau VR-013 (ORD) · **hàng ASN sửa tay sau VR-015 (2026-09-21)** · **hàng FEED sửa tay sau VR-016 (2026-09-21)** · verdict lấy từ sổ coverage mới nhất của từng module.

## Tổng quan

**119/221 TC v1.1 có verdict cuối = 53.8%** · ✅ PASS **71** (32.1%) · ❌ FAIL 28 · 🚫 BLOCKED 15 · ⛔ N-A 5 · ⏳ chưa có verdict **102** (46.2%)

| Module | TC v1.1 | ✅ PASS | ❌ FAIL | 🚫 BLOCKED | ⛔ N-A | ⏳ Chưa xong | **% có verdict** | % PASS | Sổ coverage |
|---|--:|--:|--:|--:|--:|--:|--:|--:|---|
| **ACT** | 10 | 0 | 0 | 0 | 0 | 10 | **0%** | 0% | ❌ chưa có (chưa vibe-test) |
| **ASN** | 13 | 10 | 0 | 3 | 0 | 0 | **100%** | 77% | ✅ có |
| **CNL** | 13 | 0 | 0 | 0 | 0 | 13 | **0%** | 0% | ❌ chưa có (chưa vibe-test) |
...
| **Σ** | **221** | **71** | 28 | 15 | 5 | **102** | **53.8%** | 32.1% | |

> `DESCOPED` (loại khỏi mẫu số): TC-USR-041, TC-USR-044.

## TC v1.1 chưa xong theo module (⏳ chưa chạy · ⚠️ thiếu ảnh · ❌ FAIL · 🚫 BLOCKED)

- **ACT** — chưa chạy 10: 001 005 012 013 014 015 008 016 017 018
- **ASN** — chưa chạy 0: — · FAIL/BLOCKED: 008🚫 024🚫 026🚫
- **CNL** — chưa chạy 13: 010 017 018 019 004 006 009 015 016 020 021 012 022
