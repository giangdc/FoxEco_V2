...
|-----|------|-------------------|------------------|
| VR-011 | 2026-09-19 | **12** | 7P / 2F / 2B / 1NE |
...
| TC-GIFT-012 | ❌ FAIL | SC-GIFT-012 | P2 | Check người vận chuyển nhận thông báo quà cảm ơn và nhấn vào mở Trang cá nhân | VR-011 | `VR-011-GIFT-2026-09-19/screenshots/TC-GIFT-012__step4-FAIL-mo-qua-da-nhan-khong-phai-trang-ca-nhan.png` | 🐞 Nhấn thông báo mở **"Quà đã nhận"** thay vì **màn Cá nhân** — app mâu thuẫn với chính câu chữ thông báo. Thông báo `NTF-07` CÓ và khớp verbatim (thiếu mỗi emoji 🎁 — trang trí, không hạ verdict vì lý do này) |
...
| Verdict | Số | TC |
|---|---|---|
| ✅ PASS | 7 | `TC-GIFT-001` · `TC-GIFT-002` · `TC-GIFT-004` · `TC-GIFT-005` · `TC-GIFT-006` · `TC-GIFT-007` · `TC-GIFT-009` |
| ❌ FAIL | 2 | `TC-GIFT-003` · `TC-GIFT-012` |
...
> 🔴 **2 FAIL còn lại là nợ DEV/BA — ⛔ tuyệt đối không sửa Expected theo app để làm xanh:**
> - `TC-GIFT-012`: thông báo `NTF-07` viết *"mở Trang cá nhân để xem"* nhưng deep-link mở **"Quà đã nhận"** ⇒ app tự mâu thuẫn. **Cần BA chốt**: sửa đích deep-link hay sửa câu chữ.
> - `TC-GIFT-003`: popup còn chuỗi v1.0 `"Đã gửi lời cảm ơn!"` thay vì chuỗi `BR14-02`. **Cần BA chốt** đọc chặt/lỏng trước khi log bug.
>
...
> - `TC-GIFT-008` cần **1 tài khoản CBNV trắng** — ⛔ STG **không còn** cái nào.
