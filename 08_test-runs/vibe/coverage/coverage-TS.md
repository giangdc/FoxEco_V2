...
> **Cập nhật lần cuối: QC chốt 2026-09-22 sau follow-up** · Nguồn scope: `03_test-cases/v1.1/fragments/TC-TS-v1.1.md`
> **Tổng: có verdict cuối 17/17 · CÒN NỢ 0**
...
| TC-TS-009 | ❌ FAIL | SC-TS-008 | P1 | Check gửi báo cáo sự cố hợp lệ hiện màn ghi nhận kèm cam kết liên hệ lại | VR-019 follow-up | `VR-019-TS-2026-09-22/screenshots/TC-TS-009__pre-form-filled-valid.png` · `TC-TS-009__verify-da-ghi-nhan-phan-hoi.png` | 🔴 **Đảo ngược `C-TS-03(d)` Resolved** — màn xác nhận là mặc định Microsoft Forms, không phải app-branded |
...
| TC-TS-012 | ❌ FAIL | SC-TS-009 | P2 | Check nút Gửi vô hiệu hoá khi số điện thoại sai định dạng | VR-019 follow-up | `VR-019-TS-2026-09-22/screenshots/TC-TS-012__verify-sdt-invalid-khong-bi-chan.png` | Expected đã sửa phần cơ chế nút (khớp Actual), nhưng vẫn FAIL: SĐT sai định dạng phải bị chặn mà không bị chặn (`BUG-041`, còn giữ) |
| TC-TS-013 | ❌ FAIL | SC-TS-010 | P3 | Check gửi báo cáo sự cố thành công khi không đính ảnh nào | VR-019 follow-up | `VR-019-TS-2026-09-22/screenshots/TC-TS-013__verify-anh-required-blocks-submit.png` | 🔴 **Đảo giả định gốc** — Hình ảnh đính kèm THỰC RA bắt buộc, chặn submit khi 0 ảnh |
...
| TC-TS-016 | ❌ FAIL | SC-TS-012 | P2 | Check mất mạng khi mở báo cáo sự cố thì app hiện lỗi kèm nút thử lại | VR-019 | `VR-019-TS-2026-09-22/screenshots/TC-TS-016__step6-FAIL-raw-error-no-retry-button.png` | 🐞 **BUG-038 (P2, Open)** — trang lỗi Chromium kỹ thuật, không có nút "Thử lại" |
| TC-TS-017 | 🚫 BLOCKED | SC-TS-012 | P2 | Check thử lại sau khi có mạng mở đúng form của đơn cũ không mất ngữ cảnh | VR-019 | `VR-019-TS-2026-09-22/screenshots/TC-TS-017__step6-BLOCKED-no-retry-button.png` | 🐞 **BUG-038** — không có nút "Thử lại" để thao tác tiếp; KHÔNG liên quan màn login Microsoft nên chưa retest được ở follow-up này |
...
| TC-TS-021 | ❌ FAIL | SC-TS-014 | P3 | Check ô mã đơn hàng là nhãn tĩnh chỉ đọc không sửa được | VR-019 follow-up | `VR-019-TS-2026-09-22/screenshots/TC-TS-021__verify-madon-read-only-khong-sua-duoc.png` | 🔴 **Đảo ngược `C-TS-03(b)` Resolved** — ô THỰC RA sửa được (bàn phím bật, ký tự chèn được) |
