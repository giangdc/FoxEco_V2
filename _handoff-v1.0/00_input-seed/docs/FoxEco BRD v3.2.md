# FoxEco — BRD v3.2 · 01 Gửi Hàng

*Business Requirements Document · v3.2 — Cập nhật 27/07/2026 · FoxEco — FPT Telecom*
...
Quy tắc kiểm tra dữ liệu và giá trị mặc định cho từng ô nhập ở 2 luồng tạo tin: Đơn cần gửi (người gửi) và Tin nhận giao / thuận đường (người vận chuyển). Dựa trên prototype hiện tại.

### D8.1 — Đơn cần gửi hàng (người gửi đăng tin)

| Trường | Bắt buộc | Mặc định | Validate |
| --- | --- | --- | --- |
...
### D8.2 — Tin nhận giao hàng / thuận đường (người vận chuyển đăng)

| Trường | Bắt buộc | Mặc định | Validate |
| --- | --- | --- | --- |
| Tên người giao | Có | Điền sẵn từ tài khoản đăng nhập | Chỉ đọc (lấy từ hồ sơ nhân viên) |
| SĐT người giao | Có | Điền sẵn từ tài khoản | SĐT VN hợp lệ; chỉ lộ sau khi ghép |
...
| Từ ngày | Có | Ngày hiện tại | Thời gian bắt đầu có thể giao. Không chọn ngày trong quá khứ |
...
| Thời gian di chuyển | Có | 17:30 – 18:30 | đến > từ; khoảng tối thiểu 30 phút |
| Xác nhận điều khoản | Có | Chưa tick | Bắt buộc tick mới bật nút đăng tin |

### D8.3 — Quy tắc chung cho form
...
| VAL-05 | Sửa đơn: form nạp sẵn dữ liệu cũ; áp dụng cùng bộ validate; chỉ mở khi đơn còn "Chờ ghép" (xem OPR-10) |